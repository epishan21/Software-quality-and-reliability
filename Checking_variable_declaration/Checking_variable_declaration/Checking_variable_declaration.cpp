...
vector<string> Read_file(vector<string> text, string path, string exp_file_extension)
{
    ...
    {
        /// Исключение, если у файла с текстом программы отсутствует расширение
        ...
        /// Исключение, если было неверно указано расширение файла с текстом программы
    ...
    else if (exp_file_extension == ".txt")
    {
        ...
        /// Исключение, если было неверно указано расширение файла с именами переменных
        if (exp_file_extension != file_extension)
        {
...
void Spell_check(vector<string> text, bool type)
{
    ...
    int size = text.size();
    /// Исключение, если отсутсвуют данные в файле с текстом программы
    if (size == 0)
    {
    ...
    if (type == 0)
    {
        for (int i = 0; i < size; i++)
        {
            ...
            /// Исключение, если в тексте программы присутствуют многострочные комментарии
            if (text[i].find("/*") != -1) 
            {
            ...
            {
                /// Исключение, если в тексте программы присутствуют макросы
                ...
                /// Исключение, если введены недопустимые символы в тексте программы 
                if (string_without_comment.find_first_of(rus_letters) != -1) 
                {
                    throw Exception("Введены недопустимые символы в тексте программы. Используйте латинский алфавит для записи. Код Ошибки: ", "9");
                }       

                /// Исключение, если некоторые элементарные инструкции записаны на одной строке  
                if (string_without_comment.find("for") == -1) // Если в строке нет оператора for
                {
        ...
        /// Исключение, если в тексте программы присутствуют глобальные переменные
    ...
    else if (type == 1)
    {
        for (int i = 0; i < size; i++)
        {
            /// Исключение, если отсутсвуют данные в файле с именами переменных
            if (size == 0)
            {
                throw Exception("Отсутсвуют данные в файле с именами переменных. Код Ошибки: ", "15");
            }
            /// Исключение, если введены недопустимые символы в названиях переменных
...
void Write_to_file(vector<string> result, string path_out)
{
    ...
    /// Исключение, если у файла отсутствует расширение
    ...
    /// Исключение, если было неверно указано расширение файла
    if (exp_file_extension != file_extension)
    {
    ...
    /// Исключение, если неверный путь к файлу
